  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100 transition duration-300">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Quản lý Lớp học</h1>
        ...
        <button
          ...
          className="mt-4 md:mt-0 flex items-center justify-center px-6 py-2.5 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold rounded-xl hover:from-purple-700 hover:to-indigo-700 transition duration-300 shadow-md shadow-purple-200"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {classes.map(cls => (
          <div key={cls.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col hover:shadow-md transition duration-300 hover:border-purple-200 group">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-xl font-bold text-gray-900 group-hover:text-purple-700 transition-colors">{cls.name}</h3>
              <span className="bg-purple-50/50 text-purple-700 text-xs font-semibold px-2.5 py-1 rounded-md border border-purple-100/50 select-all cursor-pointer">
                Mã: {cls.join_code}
              </span>
            </div>
            ...
            <Link
              ...
              className="mt-auto w-full inline-flex justify-center items-center px-4 py-2.5 font-bold rounded-xl text-purple-700 bg-purple-50 group-hover:bg-purple-600 group-hover:text-white transition-colors duration-300"
            >
        ...
        {classes.length === 0 && (
          <div className="col-span-full text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col items-center">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 transition-all">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 border border-gray-100">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-2">Tạo Lớp học mới</h2>
