                    ...
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center">
                          ...
                          {topic.code && (
                            <span className="ml-3 bg-gray-100 text-gray-600 px-2.5 py-0.5 rounded-md border border-gray-200 text-xs font-medium">
                              {t('teacher.questionBank.topicList.topicCode', { code: topic.code })}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="mt-2.5 flex items-center text-xs font-medium text-gray-500">
                          ...
                          <span>{t('teacher.questionBank.topicList.createdAt', { date: new Date(topic.created_at).toLocaleDateString() })}</span>
                        </div>
                      </div>
                    </div>
