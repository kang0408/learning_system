      ...
      <div className="p-5 md:p-6 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
        <div>
          <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2.5">
            <BookOpen className="w-5 h-5 text-indigo-500" /> Bài tập đã giao
          </h2>
          <p className="text-sm text-gray-500 mt-1">Tổng cộng: {publishedAssignments.length} bài tập</p>
        </div>
      </div>
        ...
        <ul className="divide-y divide-gray-100">
          ...
          {publishedAssignments.length === 0 && (
            <div className="text-center py-12 px-6">
              ...
              <p className="text-gray-900 font-medium text-lg">Chưa có bài tập nào</p>
              <p className="text-gray-500 text-sm mt-1">Học sinh này chưa được giao bài tập nào.</p>
            </div>
          )}
        </ul>
      </div>
