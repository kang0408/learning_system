...
import { Home, Users, FileText, ClipboardList, LogOut, Menu, X } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b flex items-center justify-between px-4 z-50">
        <span className="font-bold text-xl text-purple-600">SM2 Learn - Teacher</span>
      ...
      `}>
        <div className="hidden md:flex h-16 items-center px-6 border-b">
          <span className="font-bold text-xl text-purple-600">SM2 Learn</span>
        </div>
        <div className="p-4">
